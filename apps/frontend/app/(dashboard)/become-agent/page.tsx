          ...
          {currentStatus !== "none" && (
            <Card>
              <CardContent className="flex items-center gap-4 py-4">
                ...
                <Badge variant={status.color as "default"}>
                  {status.label}
                </Badge>
              </CardContent>
            </Card>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      accept="image/*"
                      onChange={(e) =>
                        handleFileChange(e, "idCardImage", setIdCardPreview)
                      }
                      className="hidden"
                    />
                    <button
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      accept="image/*"
                      onChange={(e) =>
                        handleFileChange(e, "selfieImage", setSelfiePreview)
                      }
                      className="hidden"
                    />
                    <button
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      accept="image/*"
                      onChange={(e) =>
                        handleFileChange(e, "licenseImage", setLicensePreview)
                      }
                      className="hidden"
                    />
                    <button
